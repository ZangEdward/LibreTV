// 全局变量
let selectedAPIs = JSON.parse(localStorage.getItem('selectedAPIs') || '["ikun","wolong","kuaiyun","shanhai","wuyin","niuniu","maotai","kk_yun","naixiangxiang","ruyi","huya"]'); // 默认选中资源
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (!localStorage.getItem('hasInitializedDefaults')) {
        // 默认选中资源
        selectedAPIs = ["ikun","wolong","kuaiyun","shanhai","wuyin","niuniu","maotai","kk_yun","naixiangxiang","ruyi","huya"];
